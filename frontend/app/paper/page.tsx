      ...
      <main className="mx-auto max-w-7xl px-4 py-6 sm:py-8">
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-ink/60">
            模拟开仓按 v6.4 1H主导指标策略执行：先更新 15m/1H/4H K 线，再要求 1H 与开仓方向一致、15m确认K线成立和计划盈亏比筛选，4H/日线作为背景加减分。计划盈亏比 &gt;= 1.3:1 时才开模拟单。每单保证金 {formatCurrency(summary.margin_per_trade)}，{summary.leverage} 倍杠杆；总保证金不超过当前本金，止盈止损平仓后本金会滚动更新，盈亏已扣 {feeRatePercent}% 手续费磨损。
          </p>
        </section>
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <div className="rounded border border-ink/10 bg-white p-5">
            ...
            <div className="space-y-3 text-sm leading-6 text-ink/70">
              <p>开单条件：v6.4 1H主导指标策略触发做多/做空，1H 与开仓方向一致，15m确认K线成立，4H/日线作为质量分背景，计划盈亏比 &gt;= 1.3:1，并且系统已经给出止损和参考目标。</p>
              ...
              <p>平仓条件：刷新时如果价格触达参考目标或止损，则按当前刷新价格模拟平仓；回测里的趋势单会额外统计保本和移动止损退出。15m 单最长持仓 7 天，到期仍未触发则到期平仓。</p>
